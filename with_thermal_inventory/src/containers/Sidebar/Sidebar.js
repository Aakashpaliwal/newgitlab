...
export class Sidebar extends Component {
  ...
  render() {
    ...
    if (localStorage.getItem('role') == 'Admin') {
      adminmenu = (
        <div>
          <li><NavLink to='/ViewProduct/1'> <i class="fa fa-table"></i>Item</NavLink></li>
          <li>
            <NavLink to='/ViewEmployee'> <i class="fa fa-users"></i>
              Employee
        </NavLink></li>
        <li ><NavLink to='/ViewInventory/1'> <i class="fa fa-list-ol"></i>Stock</NavLink></li>
        <li ><NavLink to='/Viewvendors/1'> <i class="fa fa-list-ol"></i>Vendors</NavLink></li>
          <li><NavLink to='/Billing/1'> <i class="fa fa-money "></i>Orders List</NavLink></li>
          <li><NavLink to='/Inventory/1'> <i class="fa fa-exchange"></i>Purchase</NavLink></li>
          <li><NavLink to='/ViewPurchase/1'> <i class="fa fa-cart-plus"></i>Business Expenses</NavLink></li>
          <li><NavLink to='/ViewSale/1'> <i class="fa fa-share-square-o"></i>Report</NavLink></li>
        </div>
      )
    }
    return (
          ...
          <nav class="side-navbar">
            <div class="side-navbar-wrapper">
              ...
              <div class="sidenav-header d-flex align-items-center justify-content-center">
                ...
                <div class="sidenav-header-inner text-center"><img src={require('../Pages/img/Elipi-logo-PNG--Business-card.png')} alt="person" class="img-fluid rounded-circle" />
                  <h2 class="h5">{localStorage.getItem("username")}</h2><span>{localStorage.getItem("role")}</span>
                </div>
              ...
              <div class="main-menu">
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                  <li><NavLink to='/'> <i class="fa fa-bar-chart"></i>Dashboard</NavLink></li>
                  ...
                  <li ><NavLink to='/ViewInvoice'> <i class="fa fa-print"></i>Generate Bill</NavLink></li>
