...
class LineItem extends Component {
  ...
  render = () => {
    ...
    const {  index, name, item, quantity, price, homeproduct, cgst, sgst, igst, costprice, free, hsn, sellingprice } = this.props
    ...
    return (
      <div className={styles.lineItem}>
        ...
        <div >
          ...
          <select className="form-control" style={{ width: "100%" }} name="item"
        ...
        {/*<div className={styles.currency}>
          <select className="form-control" name="batch" onClick={e=>this.manualchangefunc(e,index)}>
              ...
              this.state.homeprodbatch ?
                this.state.homeprodbatch.map(function (item, id) {
                  return (
                    ...
                    <option key={id} value={item.batch}>{item.batch}</option>
                   )
                }
                )
                :
        ...
        <div><input name="quantity" type="number" step="1" min="1" value={quantity} onChange={this.props.changeHandler(this.props.index)} onFocus={this.props.focusHandler} /></div>
        ...
        {/* </div> */}
        <div className={styles.currency}>
        {this.props.currencyFormatter(cgst) || '0'}</div>
        {/* <div className={styles.currency}>{sgst || '0'} */}
          {/* - {(sgst/100)*price} */}
          {/* <input name="price" type="number" step="1" min="0.00" max="9999999.99" value={price} onChange={this.props.changeHandler(index)} onFocus={this.props.focusHandler} /> */}
        {/* </div> */}
        <div className={styles.currency}>{this.props.currencyFormatter(sgst) || '0'}</div>
        {/* <div className={styles.currency}>{igst || '0'} */}
          {/* - {(igst/100)*price} */}
          {/* <input name="price" type="number" step="1" min="0.00" max="9999999.99" value={price} onChange={this.props.changeHandler(index)} onFocus={this.props.focusHandler} /> */}
        {/* </div> */}
        {/* <div className={styles.currency}>{this.props.currencyFormatter(igst) || '0'}</div> */}
        {/* <div className={styles.currency}>
        ...
        <div>
          ...
          <i class="lni-trash" onClick={this.props.deleteHandler(this.props.index)}></i>
        </div>
