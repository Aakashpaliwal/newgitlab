                    ...
                    <div class="wrapper count-title d-flex">
                      ...
                      <div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-6">
                            <p className="text-muted">Today's Number Orders</p>
                          </div>
                          <div className="col-6">
                            <p
                          ...
                          <div className="col-6">
                            <p className="text-muted">Total Number Orders</p>
                          </div>
                          <div className="col-6">
                            <p
                              className="text-muted"
                ...
                <div className="card" style={{ marginTop: "30px" }}>
                  <div class="card-body">
                    <div>
                      <h4>Employee List</h4>
                      <hr />
                      <table className="table table-bordered table-responsive-sm table-responsive-md table-responsive-lg">
                        <thead>
                          <tr>
